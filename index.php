...
// include("php_action/process.php");
  ...
  <main>
    <nav class ="buttons">
      <ul>
        <li><a href="login.php"><button class="btn">Log in</button></a></li>
        <li><a href="registration.php"><button class="btn">Sign up</button></a></li>
      </ul>
...
but hardcoding the values for anchoring purposes--> 
        <li>
<!-- 		Other site links	 -->
          <a href="class.php" class="site-link" id="classes">
